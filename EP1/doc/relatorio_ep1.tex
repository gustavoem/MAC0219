...
% \begin{figure}[H]
%     \makebox[\textwidth][c]{\includegraphics[scale=.55]{hist/full_hist.png}}
% \end{figure}

% \begin{figure}[H]
%     \makebox[\textwidth][c]{\includegraphics[scale=.55]{hist/elephant_hist.png}}
% \end{figure}

% \begin{figure}[H]
%     \makebox[\textwidth][c]{\includegraphics[scale=.55]{hist/seahorse_hist.png}}
% \end{figure}

% \begin{figure}[H]
%     \makebox[\textwidth][c]{\includegraphics[scale=.55]{hist/spiral_hist.png}}
% \end{figure}
