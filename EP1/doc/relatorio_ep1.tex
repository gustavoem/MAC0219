...
O cálculo do conjunto em código sequencial ocorre sem nenhuma paralelização. 
No trabalho, a versão com alocação de memória e operações de IO chama-se mandelbrot\_seq.c, 
enquanto que a versão sem a alocação e sem IO chama-se mandelbrot\_seq\_s.c. 
Definimos o tamanho do nosso image\_buffer[11500 x 11500 x 3][3] como tamanho máximo 
para os nossos testes com imagens 11500px por 11500px.
...
\begin{figure}[H]
    ...
    \end{tabular}
    \caption{(b) representa uma ampliação dos dados de imagens de 2048 pixels da figura (a) .}
    \label{fig:omp_all} 
\end{figure}
