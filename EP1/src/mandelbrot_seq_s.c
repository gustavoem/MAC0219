...
void init (int argc, char *argv[]) {
    if (argc < 6) {
        ...
        printf ("    Full Picture:         ./mandelbrot_seq -2.5 1.5 \
                -2.0 2.0 11500\n");
        printf ("    Seahorse Valley:      ./mandelbrot_seq -0.8 -0.7 \
                0.05 0.15 11500\n");
        printf ("    Elephant Valley:      ./mandelbrot_seq 0.175 0.375 \
                -0.1 0.1 11500\n");
        printf ("    Triple Spiral Valley: ./mandelbrot_seq -0.188 \
